...
local Window = UI:MakeWindow({Name = "Destruction Simulator GUI", HidePremium = false, SaveConfig = true, ConfigFolder = "BloxainHub\Saves", IntroEnabled = Libary.PlayInto, IntroText = Libary.IntroName})
...
local Sim = Window:MakeTab({Name = "Destruction Simulator", Icon = "", PremiumOnly = false})
...
Sim:AddToggle({Name = "Inf Coins", Flag = "Inf Coins", Default = false, Save = true})

Sim:AddToggle({Name = "autoSell", Flag = "autoSell", Default = false, Save = true})

Sim:AddSlider({Name = "Add Levels", Flag = "Add Levels", Min = 0, Max = 9, Default = 0, Color = Color3.fromRGB(255,255,255), Increment = 1, ValueName = "Add Levels"})

Sim:AddButton({Name = "Add Levels", Callback = function() game:GetService("ReplicatedStorage").Remotes.generateBoost:FireServer("Levels", 480, UI.Flags["Add Levels"].Value) end})

Sim:AddButton({Name = "Fastrocket", Callback = function() fastrocket() end})

Sim:AddButton({Name = "No Cool Down", Callback = function() Nocooldown() end})
