...
_G.BloxainSettings = {Versoin = '0.7', Path = MainDir, Games = MainDir..'/Games', Modules = MainDir..'/Modules', WebAddress = 'https://raw.githubusercontent.com/bloxain/Roblox/main/', OldUpdate = MainDir..'/Update.JSON'}
